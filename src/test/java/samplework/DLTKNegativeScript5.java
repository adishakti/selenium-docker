...
public class DLTKNegativeScript5 {
	...
	Thread.sleep(10);
	driver.findElement(By.id("signup_username")).sendKeys("111shaga");
	Thread.sleep(10);
    driver.findElement(By.id("signup_email")).sendKeys("gaurav000@mailinator.com");
    Thread.sleep(10);
