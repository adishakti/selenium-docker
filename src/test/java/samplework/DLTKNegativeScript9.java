...
public class DLTKNegativeScript9 {
	...
	Thread.sleep(10);
	driver.findElement(By.id("signup_username")).sendKeys("01shaga");
	Thread.sleep(10);
    driver.findElement(By.id("signup_email")).sendKeys("gaurav0@mailinator.com");
    Thread.sleep(10);
