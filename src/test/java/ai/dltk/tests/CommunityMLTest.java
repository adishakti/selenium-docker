...
public class CommunityMLTest extends BaseTest {
    @Test
    @Parameters({"username","password"})
    public void CommunityMachineLearning(@Optional("Abc") String username, String password) {
        LoginPage loginPage = new LoginPage(driver);
        loginPage.goTo();
        loginPage.login(username,password);
        CommunityPage commPage = new CommunityPage(driver);
        commPage.MachineLearning();
    }
}