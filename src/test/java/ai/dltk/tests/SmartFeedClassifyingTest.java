...
public class SmartFeedClassifyingTest extends BaseTest {


    @Test
    @Parameters({"username","password"})
    public void ClassifyingTest(@Optional("Abc") String username, String password) {
        LoginPage loginPage = new LoginPage(driver);
        loginPage.goTo();
        loginPage.login(username,password);
        SmartFeedPage smartPage = new SmartFeedPage(driver);
        smartPage.ClassifyingGalaxies();
    }
}
