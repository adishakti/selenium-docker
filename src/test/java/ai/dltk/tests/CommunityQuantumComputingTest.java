...
public class CommunityQuantumComputingTest extends BaseTest {


    @Test
    @Parameters({"username","password"})
    public void QuantumComputing(@Optional("Abc") String username, String password) {
        LoginPage loginPage = new LoginPage(driver);
        loginPage.goTo();
        loginPage.login(username,password);
        CommunityPage commPage = new CommunityPage(driver);
        commPage.QuantumComputing();
    }
}