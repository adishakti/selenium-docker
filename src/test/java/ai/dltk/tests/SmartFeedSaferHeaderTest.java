...
public class SmartFeedSaferHeaderTest extends BaseTest{

	 @Test
	    @Parameters({"username","password"})
	    public void SpookierOrSafer(@Optional("Abc") String username, String password) {
	        LoginPage loginPage = new LoginPage(driver);
	        loginPage.goTo();
	        loginPage.login(username,password);
	        SmartFeedPage smartPage = new SmartFeedPage(driver);
	        smartPage.SpookierOrSafer();
